...
This is where program settings like default tip and tax rates are entered for the **Basic Edition** of the program (meaning it is being run without a Professional Edition subscription).
...
<object type=image/svg+xml data="settingspagebasic.svg"></object>

...
With this switch set bill images will be backed up to the cloud along with the bill data. If this switch is not set, only the bill data will be backed up. Note that images are never backed up in the Basic Edition of DivisiBill.

...
One slightly problematic thing about the Help is it contains a lot of PNG files which
are actually screen shots of the app. These are generated by the emulator screen snapshot
capability and used to create the help files. The PNG files are stored in the web project
but being large (100-200kB) they'll sometimes cause problems uploading to GitHub. If you 

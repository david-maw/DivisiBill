...
internal class PinchToZoomContainer : ContentView
{
    ...
    private void OnPanUpdated(object sender, PanUpdatedEventArgs e)
    {
        ...
        {
            // Store the current translation applied to the wrapped user interface element (probably an image)
            Content.AnchorX = 0;
            Content.AnchorY = 0;
            xOffset = Content.TranslationX;
            yOffset = Content.TranslationY;
        ...
        {
            // Apply translation based on the change in origin.
            Content.TranslationX = e.TotalX + xOffset;
            Content.TranslationY = e.TotalY + yOffset;
        }
